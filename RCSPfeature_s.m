function [fTrain,fTest]=RCSPfeature_s(xTrain,yTrain,xTest,nfilter,gamma)
%%  train CSP filters
    ...
    SigmaST0=(1-gamma)*Sigma0+gamma*trace(Sigma0)*eye(nChannel)/nChannel;
    SigmaST1=(1-gamma)*Sigma1+gamma*trace(Sigma1)*eye(nChannel)/nChannel;
